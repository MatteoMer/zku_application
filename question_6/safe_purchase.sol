...
contract Purchase {
    ...
    modifier isAllowed() {
        // If the sender is not the buyer and that the transaction was made less than 5 minutes ago, revert
        ...
        isAllowed
    {
        ...
        emit ItemReceived();
        state = State.Inactive; // We don't need the "Release" state anymore, since we're now doing both transfer in the same transaction
